...
class Practicum {
    public static void main(String[] args) {
        ...
        String command = console.nextLine(); // // вместо многоточия используйте нужный метод класса Scanner
        ...
        if (command.equals("convert")) { // сравните переменную command с командой для конвертации
            ...
            String currency = scanner.nextLine(); // считайте это значение с помощью scanner
